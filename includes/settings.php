...
jQuery(document).ready(function() {
    ...
    <tr>
                    ...
                    <?php settings_fields( 'baw-settings-group' ); ?>
                    	<table class="inner-setings">
                            ...
                            <tr>
                                ...
                                <td><input id="upload_image" type="text" name="upload_image" value="<?php echo get_option('upload_image'); ?>" />
		<input id="upload_image_button" type="button" value="Upload Image" class="button-primary" /><span>Upload a custom button image here or leave blank to use payapl default Buy Now</span></td>
                            </tr>
                            <tr>
                            	<td width="150" style="line-height:27px;">Return Url</td>
                                <td><input type="text" name="return_url" value="<?php echo get_option('return_url'); ?>"   /><span>The url you want customers to return to after purchase</span></td>
                            </tr>
                        </table>
                         <p class="submit">
      ...
      <td valign="top" width="28%"><table cellpadding="0" class="widefat donation" style="margin-bottom:10px; border:solid 2px #008001;" width="50%">
                ...
                <tbody>
                    ...
                    <tr>
                    	<td style="border:0;">You can also help by <a href="http://wordpress.org/extend/plugins/paypal-responder/" target="_blank">rating this plugin on wordpress.org</a></td>
                    </tr>
                   
                </tbody>
            </table><table cellpadding="0" class="widefat" border="0">
            	<thead>
                	<th scope="col">Need Support?</th>
                </thead>
                <tbody>
                	<tr>
                    	<td style="border:0;">If you are having problems with this plugin please talk about them on the <a href="http://wordpress.org/support/plugin/paypal-responder" target="_blank">Support Forum</a></td>
                    </tr>
 ...
 <table class="wp-paypal" style="margin-top:20px;"> 
    <tbody><tr>
    	<td valign="top" width="75%" style="padding-right:20px;">
            <table class="widefat posts" cellspacing="0">
                <thead>
                <tr>
                    <th scope="col">Email Auto-Responder</th>	
                </tr>
                </thead>
               <tbody id="the-list">
                <tr valign="top">
                    <td>
                    <form name="frm" method="post" action="options.php">
                     <?php settings_fields( 'baw-settings-group1' ); ?>                    	
                     <table class="inner-setings">
                        	<tbody>
                            
                            <tr>
                            	<td width="150" style="line-height:27px;">From Email</td>
                                <td><input type="text" name="from_email" value="<?php echo get_option('from_email'); ?>"></td>
                            </tr>
                            
                            <tr>
                            	<td width="150" style="line-height:27px;">Email Subject</td>
                                <td><input type="text" name="email_subject" value="<?php echo get_option('email_subject'); ?>"></td>
                            </tr>
                            
                            
                            <tr>
                            	<td width="150" style="line-height:27px;">Message</td>
                                <td><textarea name="email_message"><?php echo get_option('email_message'); ?></textarea></td>
                            </tr>
                            <tr>
